 ...
 * Leaflet Control Geocoder, not to fund other projects.
 *
 * Please get your own Mapbox account if you like their maps, it's not that expensive.
 * I and the other contributors to Leaflet Control Geocoder give it and its source away for free,
 * stealing this key from me to save a few bucks feels a bit cheap, to be honest.
 */
window.LCG = {
	apiToken: 'pk.eyJ1IjoibGllZG1hbiIsImEiOiIyZmM4MDYxMTdiMTYwOTIyYzg1YmQxMGM3YTRhNjY0NCJ9.gJ6ITQll8ikdsYYtNtAjkg'
};
